 ...
 */
	if (file_exists($code_page_directory . '/' . $template_dir . '/' . $value))
	{
		require($code_page_directory . '/' . $template_dir . '/' . $value);
	}
	else
	{
...
$zv_onload = '';
if (isset($za_onload_array) && 0 < count($za_onload_array)) $zv_onload=implode(';',$za_onload_array);
