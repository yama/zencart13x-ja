  ...
  if ($_GET['action']) {
    switch ($_GET['action']) {
      ...
      case 'multi_update':
        ...
        $layout_box_sort_order_single = zen_db_prepare_input($_POST['layout_box_sort_order_single']);
        $layout_box_status_single = zen_db_prepare_input($_POST['layout_box_status_single']);
        foreach ($layout_box_name as $key => $value) {
        	$db->Execute("update " . TABLE_LAYOUT_BOXES . " set layout_box_status= '" . $layout_box_status[$key] . "',
        	                    layout_box_location= '" . $layout_box_location[$key] . "',
        	                    layout_box_sort_order='" . $layout_box_sort_order[$key] . "',
        	                    layout_box_sort_order_single='" . $layout_box_sort_order_single[$key] . "',
        	                    layout_box_status_single='" . $layout_box_status_single[$key] . "'
        	                    where layout_box_name='" . $value . "'
...
<?php
  ...
  $pulldown_yes_no[] = array('id' => 0, 'text' => TEXT_OFF);
  $pulldown_yes_no[] = array('id' => 1, 'text' => TEXT_ON);
  $pulldown_location[] = array('id' => 0, 'text' => TEXT_LEFT);
  $pulldown_location[] = array('id' => 1, 'text' => TEXT_RIGHT);
  echo zen_draw_form('column_controller', FILENAME_LAYOUT_CONTROLLER, 'page=' . $_GET['page'] . '&action=multi_update');
...
?>
                <td class="dataTableContent" width="100"><?php echo (file_exists($boxes_directory_template . $column_controller->fields['layout_box_name']) ? '<span class="alert">' . ereg_replace(DIR_FS_CATALOG_MODULES, '', $boxes_directory_template) . '</span>' . $column_controller->fields['layout_box_name'] : ereg_replace(DIR_FS_CATALOG_MODULES, '', $boxes_directory) . $column_controller->fields['layout_box_name']) . zen_draw_hidden_field('layout_box_name[' . $column_controller->fields['layout_id'] . ']', $column_controller->fields['layout_box_name']); ?></td>
                <td class="<?php echo ( (file_exists($boxes_directory . $column_controller->fields['layout_box_name']) or file_exists($boxes_directory_template . $column_controller->fields['layout_box_name'])) ? dataTableContent : messageStackError ); ?>" align="center"><?php echo zen_draw_pull_down_menu('layout_box_status[' . $column_controller->fields['layout_id'] . ']', $pulldown_yes_no, $column_controller->fields['layout_box_status']); ?></td>
                <td class="<?php echo ( (file_exists($boxes_directory . $column_controller->fields['layout_box_name']) or file_exists($boxes_directory_template . $column_controller->fields['layout_box_name'])) ? dataTableContent : messageStackError ); ?>" align="center"><?php echo zen_draw_pull_down_menu('layout_box_location[' . $column_controller->fields['layout_id'] . ']', $pulldown_location, $column_controller->fields['layout_box_location'])?></td>
                <td class="<?php echo ( (file_exists($boxes_directory . $column_controller->fields['layout_box_name']) or file_exists($boxes_directory_template . $column_controller->fields['layout_box_name'])) ? dataTableContent : messageStackError ); ?>" align="center"><?php echo zen_draw_input_field('layout_box_sort_order[' . $column_controller->fields['layout_id'] . ']', $column_controller->fields['layout_box_sort_order'], ' size=3'); ?></td>
                <td class="<?php echo ( (file_exists($boxes_directory . $column_controller->fields['layout_box_name']) or file_exists($boxes_directory_template . $column_controller->fields['layout_box_name'])) ? dataTableContent : messageStackError ); ?>" align="center"><?php echo zen_draw_input_field('layout_box_sort_order_single[' . $column_controller->fields['layout_id'] . ']', $column_controller->fields['layout_box_sort_order_single'], ' size=3'); ?></td>
                <td class="<?php echo ( (file_exists($boxes_directory . $column_controller->fields['layout_box_name']) or file_exists($boxes_directory_template . $column_controller->fields['layout_box_name'])) ? dataTableContent : messageStackError ); ?>" align="center"><?php echo zen_draw_pull_down_menu('layout_box_status_single[' . $column_controller->fields['layout_id'] . ']', $pulldown_yes_no, $column_controller->fields['layout_box_status_single']); ?></td>
...
?>
              <tr valign="top">
                <td colspan="7" valign="top" align="right"><?php echo zen_image_submit('button_update.gif', IMAGE_UPDATE); ?></form></td>
              </tr>
            </table></td>
<?php
  $heading = array();
