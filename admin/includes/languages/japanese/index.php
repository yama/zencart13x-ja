...
// +----------------------------------------------------------------------+
//  $Id: index.php 17 2008-02-14 03:43:21Z bigmouse-sugimoto $
//
...
define('ERROR_ADMIN_DIR_NAME', '管理画面のディレクトリ名がデフォルトの admin のままです。セキュリティ上好ましくないので別の名称に変更してください。');
define('ERROR_REGISTER_GLOBAL_ON', 'レジスターグローバルがONになっています。セキュリティ上危険ですので必ずOFFにしておいてください。');
?>