...
// +----------------------------------------------------------------------+
// $Id: email_extras.php 17 2008-02-14 03:43:21Z bigmouse-sugimoto $
//
...
// email disclaimer
  define('EMAIL_DISCLAIMER', 'このメールアドレスは、あなたもしくはあなたのお客様からいただいたものです。
このメールに心当たりがない方は、お手数ですが %s までお知らせください。');
  define('EMAIL_SPAM_DISCLAIMER','このメールは、「特定電子メールの送信の適正化等に関する法律」の表示義務' . "\n" . '（第３条）に準拠して送信されました。購読削除を希望される場合は、差出人アドレスにリクエストいただければ速やかに対処いたします。');
