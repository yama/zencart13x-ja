...
// +----------------------------------------------------------------------+
//  $Id: salemaker.php 17 2008-02-14 03:43:21Z bigmouse-sugimoto $
//
...
define('TEXT_MORE_INFO', '(詳細)');

define('TEXT_WARNING_SALEMAKER_PREVIOUS_CATEGORIES','&nbsp;警告 : 既に %s つのセール対象になっているカテゴリです');
?>