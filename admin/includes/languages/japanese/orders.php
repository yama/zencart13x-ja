 ...
 * @version $Id: orders.php 17 2008-02-14 03:43:21Z bigmouse-sugimoto $
 */

define('HEADING_TITLE', '注文管理');
define('HEADING_TITLE_SEARCH', '注文ID:');
define('HEADING_TITLE_STATUS', 'ステータス:');
define('HEADING_TITLE_SEARCH_DETAIL_ORDERS_PRODUCTS', '商品名、<strong>商品ID:XX</strong>、もしくは型番で検索');
define('TEXT_INFO_SEARCH_DETAIL_FILTER_ORDERS_PRODUCTS', '検索条件: ');
...
define('TEXT_INFO_HEADING_DELETE_ORDER', '注文の削除');
...
define('TEXT_PAID', '支払済');
define('TEXT_UNPAID', '未支払');
...
define('TEXT_DOWNLOAD_FILENAME', 'ファイル名');
...
define('TEXT_DELETE_CVV_REPLACEMENT','削除されています');
define('TEXT_MASK_CC_NUMBER','この数にマスクをかけてください');

define('TEXT_INFO_EXPIRED_DATE', '利用期日:<br />');
define('TEXT_INFO_EXPIRED_COUNT', '利用回数:<br />');

define('TEXT_PRODUCTS_ORDERED','注文商品点数: ');
define('TABLE_HEADING_CUSTOMER_COMMENTS', '顧客コメント');
define('TEXT_COMMENTS_YES', '顧客からのコメント - 有');
define('TEXT_COMMENTS_NO', '顧客からのコメント - 無');
?>