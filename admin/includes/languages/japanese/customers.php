...
define('CUSTOMERS_AUTHORIZATION_4', '禁止 - ログイン、購入が許可されていません。');
...
define('ADDRESS_BOOK_TITLE', '登録アドレス一覧');
define('PRIMARY_ADDRESS', '(デフォルト)');
define('TEXT_MAXIMUM_ENTRIES', '<span class="coming"><strong>注意:</strong></span> 最大 %s 件までの登録可能です');
