...
// +----------------------------------------------------------------------+
//  $Id: product.php 17 2008-02-14 03:43:21Z bigmouse-sugimoto $
//
...
define('TEXT_PRODUCT_SPECIAL_ALWAYS_FREE_SHIPPING', '特別：配送先指定の必要な、通常商品とダウンロード商品の組み合わせ');//Special, Product/Download Combo Requires a Shipping Address
...
// meta tags
  define('TEXT_META_TAG_TITLE_INCLUDES','</strong>＜title＞に挿入する情報の指定</strong>');
