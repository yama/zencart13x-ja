...
// +----------------------------------------------------------------------+
//  $Id: coupon_admin.php 17 2008-02-14 03:43:21Z bigmouse-sugimoto $
//
...
define('TEXT_TO_REDEEM', '商品購入時にこのクーポンを使用することができます。' . "\n" . '支払情報を入力するときに下記のクーポンコードを指定してください。');
define('TEXT_IN_CASE', ' 問題が発生した場合 ');
define('TEXT_VOUCHER_IS', 'クーポン コード ');
define('TEXT_REMEMBER', 'クーポン コードをなくさないよう安全な場所に保存してください。');
define('TEXT_VISIT', 'ショップへはこちらから... %s');
define('TEXT_ENTER_CODE', ' クーポンコードを入力してください。 ');
define('TEXT_COUPON_HELP_DATE', '<p><p>このクーポンの有効期限は %s から %s までとなっております。</p></p>');
define('HTML_COUPON_HELP_DATE', '<p><p>このクーポンの有効期限は %s から %s までとなっております。</p></p>');
...
define('COUPON_ZONE_RESTRICTION', 'クーポン適応地域');
define('TEXT_COUPON_ZONE_RESTRICTION', '地域を選択した場合は選択された地域のみでクーポンが利用できるようになります');
...
define('ERROR_DISCOUNT_COUPON_WELCOME', 'クーポンを無効にする事ができません。このクーポンは、新規会員登録時のプレゼントクーポンに指定されています。<br /><br />このクーポンを削除する前に、新規会員登録時のプレゼントクーポンを変更してください。');
define('SUCCESS_COUPON_DISABLED', '処理完了! クーポンは無効になりました ...');
...
define('SUCCESS_COUPON_DUPLICATE', '処理完了! クーポンをコピーしました ...<br /><br />クーポンの名前と日付を確認してください ...');
?>
