...
define('TEXT_LEGEND_TAX_AND_ZONES', ': 税率・地域が設定されています');
define('TEXT_LEGEND_ONLY_ZONES', ': 地域のみ設定されています ');
define('TEXT_LEGEND_NOT_CONF', ': 設定されていません ');
define('TABLE_HEADING_TAX_ZONES_DESCRIPTION', '説明');
