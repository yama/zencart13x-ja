...
// +----------------------------------------------------------------------+
//  $Id: sqlpatch.php 17 2008-02-14 03:43:21Z bigmouse-sugimoto $
//
  ...
  define('HEADING_WARNING_INSTALLSCRIPTS', '注意：Zen Cart のデータベースアップグレートスクリプトはこのページからは実行しないでください。<br />より確実な方法として、新しい <strong>zc_install</strong> フォルダをアップロードし、そちらからアップグレードを行ってください');
