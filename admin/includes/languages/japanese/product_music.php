...
// +----------------------------------------------------------------------+
//  $Id: product_music.php 17 2008-02-14 03:43:21Z bigmouse-sugimoto $
//
...
define('TEXT_PRODUCT_IS_VIRTUAL', 'はい、送付先住所の入力をスキップ');
define('TEXT_PRODUCT_NOT_VIRTUAL', 'いいえ、送付先住所の入力は必要');
