...
// +----------------------------------------------------------------------+
//  $Id: categories.php 17 2008-02-14 03:43:21Z bigmouse-sugimoto $
//
...
define('TEXT_DELETE_CATEGORY_INTRO_LINKED_PRODUCTS', '<strong>警告:</strong> マスタカテゴリＩＤの削除されたリンク商品は、正しく価格計算が行われません。リンク商品を含むカテゴリを削除する場合は、その前にそれらの商品のマスタカテゴリＩＤを他のカテゴリＩＤに設定しなおしていることを確認してください。');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_CATEGORIES_IMAGE_MANUAL', '<strong>サーバー内の画像ファイルを直接指定する 　ファイル名:</strong>');
...
define('WARNING_PRODUCTS_IN_TOP_INFO', '警告: トップレベルのカテゴリに商品を登録しています。カタログ内において、価格計算が正しく動作しなくなります。　商品: ');
