...
// +----------------------------------------------------------------------+
//  $Id: store_manager.php 17 2008-02-14 03:43:21Z bigmouse-sugimoto $
//
//
  ...
  define('TEXT_LANGUAGE_LOOKUP_CURRENT_CATALOG_TEMPLATE', '全ての現在選択中の言語ファイル - ' . DIR_WS_CATALOG . DIR_WS_LANGUAGES . $_SESSION['language'] . '/*.php');
  ...
  define('TEXT_LANGUAGE_LOOKUP_CURRENT_ADMIN_LANGUAGE', '全ての現在選択中の言語ファイル - 管理者ページ(Admin) (' . DIR_WS_ADMIN . DIR_WS_LANGUAGES . $_SESSION['language'] . '/*.php)');
  define('TEXT_LANGUAGE_LOOKUP_CURRENT_ALL', '全ての現在選択中の言語ファイル - ショップページ(Catalog)/管理者ページ(Admin)');

  define('TEXT_INFO_NO_EDIT_AVAILABLE','編集不可');
  define('TEXT_INFO_CONFIGURATION_HIDDEN', ' もしくは非表示');

  define('TEXT_INFO_DATABASE_OPTIMIZE', '<strong>データベース最適化</strong> 削除されたレコードによる無駄なスペースを除去します。<br />頻繁に更新されるデータベースでは、毎月または毎週実行すべきかもしれません。<br />（アクセスの少ない時間帯での実行をお勧めします）');
  define('SUCCESS_DB_OPTIMIZE', 'データベース最適化 - 処理されたテーブル: ');
