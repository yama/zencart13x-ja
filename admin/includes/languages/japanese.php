...
// meta tags
define('ICON_METATAGS_ON', 'メタタグの定義あり');
define('ICON_METATAGS_OFF', 'メタタグを定義なし');
...
define('WARNING_ADMIN_DOWN_FOR_MAINTENANCE', '<strong>警告</strong> サイトは現在メンテナンス中のため閉鎖されています。<br />注意: メンテナンス時には、Paymentや送料のモジュールテストを行なうことはできません。');
 //Translate
define('WARNING_BACKUP_CFG_FILES_TO_DELETE', '警告: 安全性を保つためこれらのファイルを削除してください。: ');
define('WARNING_INSTALL_DIRECTORY_EXISTS', '警告:インストールフォルダーは : ' . DIR_FS_CATALOG . 'zc_installにあります。安全のためこのフォルダを削除してください。');
define('WARNING_CONFIG_FILE_WRITEABLE', '警告: お客様の環境設定ファイル: %sincludes/configure.php. こちらは安全性において危険な可能性があります。-こちらのファイルで正しいユーザー許可の設定をお願いします。(read-only, CHMOD 644 または 444 が通常の設定です)。');
...
// search filters
  ...
  //Translate
  define('HEADING_TITLE_SEARCH_DETAIL_REPORTS', '商品の検索 - カンマで区切る');
  define('HEADING_TITLE_SEARCH_DETAIL_REPORTS_NAME_MODEL', '商品名／モデルの検索');
...
define('ENTRY_NOTHING_TO_SEND','メッセージの入力内容がありません。');
 define('EMAIL_SEND_FAILED','エラー: "%s"へのメール送信失敗 <%s> 件名: "%s"');
 //Translate
 ...
 //Translate
  define('ERROR_EDITORS_FOLDER_NOT_FOUND', ' \'My Store\' で選択されたHTMLエディターがあります。しかしその \'/editors/\' フォルダーを設定することはできません。お客様の選択の機能を無効にするか、エディターファイルを \''.DIR_WS_CATALOG.'エディター/\' フォルダーに移動してください。');


  define('TEXT_CATEGORIES_PRODUCTS_SORT_ORDER_INFO', 'カテゴリ/商品 表示順: ');
 ...
 define('TABLE_HEADING_YES','はい');
  ...
  define('TEXT_PRODUCTS_IMAGE_MANUAL', '<br /><strong>または、サーバ、ファイル名からの既存のイメージ・ファイルを選択してください</strong>');
 define('TEXT_IMAGES_OVERWRITE', '<strong>サーバー上の画像を上書きしますか？</strong>');
  define('TEXT_IMAGE_OVERWRITE_WARNING','警告: FILENAME は更新されましたが、ファイルの上書きはしていません。');
//Translate

  define('TEXT_IMAGES_DELETE', '<strong>画像を削除しますか？</strong> 注:　商品から画像を削除しても、画像はサーバーからなくなりません。:');
