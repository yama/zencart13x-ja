...
?>
          ...
          <tr>
			...
			<tr>
			<td class="main" colspan="3"><?php echo zen_draw_separator('pixel_trans.gif', '75', '3'); ?><?php if ($pInfo->products_image != '') echo zen_image(DIR_WS_CATALOG_IMAGES . $pInfo->products_image); ?></td>
			</tr>
              <tr>
