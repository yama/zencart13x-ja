 ...
 * @version $Id: products_to_categories.php 2 2010-11-05 09:04:44Z kitsune3 $
 */
    ...
    default:
      ...
      switch (true) {
        case ($product_to_copy->fields['master_categories_id'] == 0 and $products_filter > 0):
          ...
          break;
        default:
          $contents[] = array('text' => '<form action="' . FILENAME_PRODUCTS_TO_CATEGORIES . '.php' . '?action=edit&products_filter=' . $products_filter . '&current_category_id=' . $current_category_id . '" method="post">' . zen_draw_hidden_field('securityToken', $_SESSION['securityToken']));
