 ...
 * @version $Id: orders.php 5 2010-11-27 07:29:30Z kitsune3 $
 */
...
//          $update_downloads_query = "update " . TABLE_ORDERS_PRODUCTS_DOWNLOAD . " set download_maxdays='0', download_count='0' where orders_id='" . $_GET['oID'] . "' and orders_products_download_id='" . $_GET['download_reset_off'] . "'";
      ...
      case 'update_order':
        ...
        if ( ($check_status->fields['orders_status'] != $status) || zen_not_null($comments)) {
          ...
          $guest_check = $db->Execute("select c.customers_id from " . TABLE_CUSTOMERS . " c, " . TABLE_ORDERS . " o
                                                   where o.orders_id = '" . $oID . "'
                                                   and o.customers_id = c.customers_id");
          $guest_flag = false;
          if ($guest_check->fields['customers_id'] == '') $guest_flag = true;
...
//    $new_fields = ", o.customers_company, o.customers_email_address, o.customers_street_address, o.delivery_company, o.delivery_name, o.delivery_street_address, o.billing_company, o.billing_name, o.billing_street_address, o.payment_module_code, o.shipping_module_code, o.ip_address ";
    ...
    $new_fields = ", o.customers_company, o.customers_email_address, o.customers_street_address,
                         ...
                         o.billing_name, o.billing_street_address, o.payment_module_code, o.shipping_module_code, o.ip_address ";
