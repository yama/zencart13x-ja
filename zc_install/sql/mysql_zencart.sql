...
INSERT INTO configuration (`configuration_title`, `configuration_key`, `configuration_value`, `configuration_description`, `configuration_group_id`, `sort_order`, `last_modified`, `date_added`, `use_function`, `set_function`) VALUES( '左側サイドボックスの横幅', 'BOX_WIDTH_LEFT', '150px', '左側に表示されるサイドボックスの横幅を設定します。pxを含めて入力できます。\r\n<br /><br />\r\n・デフォルト = 150px', 19, 1, NULL, now(), NULL, NULL);

INSERT INTO configuration (`configuration_title`, `configuration_key`, `configuration_value`, `configuration_description`, `configuration_group_id`, `sort_order`, `last_modified`, `date_added`, `use_function`, `set_function`) VALUES( '右側サイドボックスの横幅', 'BOX_WIDTH_RIGHT', '150px', '右側に表示されるサイドボックスの横幅を設定します。pxを含めて入力できます。<br /><br />\r\n・Default = 150px', 19, 2, NULL, now(), NULL, NULL);
...
INSERT INTO configuration (`configuration_title`, `configuration_key`, `configuration_value`, `configuration_description`, `configuration_group_id`, `sort_order`, `last_modified`, `date_added`, `use_function`, `set_function`) VALUES( '左側カラムの横幅', 'COLUMN_WIDTH_LEFT', '150px', '左側カラムの横幅を設定します。pxを含めて指定可能。<br /><br />\r\nデフォルト = 150px', 19, 20, NULL, now(), NULL, NULL);

INSERT INTO configuration (`configuration_title`, `configuration_key`, `configuration_value`, `configuration_description`, `configuration_group_id`, `sort_order`, `last_modified`, `date_added`, `use_function`, `set_function`) VALUES( '右側カラムの横幅', 'COLUMN_WIDTH_RIGHT', '150px', '右側カラムの横幅を設定します。pxを含めて指定可能。<br /><br />\r\nデフォルト = 150px', 19, 21, NULL, now(), NULL, NULL);
...
INSERT INTO product_types (`type_id`, `type_name`, `type_handler`, `type_master_type`, `allow_add_to_cart`, `default_image`, `date_added`) VALUES(1, 'Product - General', 'product', 1, 'Y', '', now());
INSERT INTO product_types (`type_id`, `type_name`, `type_handler`, `type_master_type`, `allow_add_to_cart`, `default_image`, `date_added`) VALUES(2, 'Product - Music', 'product_music', 1, 'Y', '', now());
INSERT INTO product_types (`type_id`, `type_name`, `type_handler`, `type_master_type`, `allow_add_to_cart`, `default_image`, `date_added`) VALUES(3, 'Document - General', 'document_general', 3, 'N', '', now());
INSERT INTO product_types (`type_id`, `type_name`, `type_handler`, `type_master_type`, `allow_add_to_cart`, `default_image`, `date_added`) VALUES(4, 'Document - Product', 'document_product', 3, 'Y', '', now());
INSERT INTO product_types (`type_id`, `type_name`, `type_handler`, `type_master_type`, `allow_add_to_cart`, `default_image`, `date_added`) VALUES(5, 'Product - Free Shipping', 'product_free_shipping', 1, 'Y', '', now());
...
INSERT INTO project_version_history (`project_version_id`, `project_version_key`, `project_version_major`, `project_version_minor`, `project_version_patch`, `project_version_comment`, `project_version_date_applied`) VALUES(1, 'Zen-Cart Main', '1', '3.9', '', 'Fresh Installation', now());
INSERT INTO project_version_history (`project_version_id`, `project_version_key`, `project_version_major`, `project_version_minor`, `project_version_patch`, `project_version_comment`, `project_version_date_applied`) VALUES(2, 'Zen-Cart Database', '1', '3.9', '', 'Fresh Installation', now());
...
INSERT INTO zones_to_geo_zones (`association_id`, `zone_country_id`, `zone_id`, `geo_zone_id`, `date_added`) VALUES(1, 107, NULL, 1, now());
...
INSERT INTO configuration VALUES(0, 'DBによる多重注文防止を利用する', 'REPETITION_CHECK_ENABLED', 'true', '注文画面での購入ボタン多重クリックによる重複注文を防止するためにDBを利用するかどうかの設定をします<br />true 利用する<br />false 利用しない', 1, 130, NULL, now(), NULL, 'zen_cfg_select_option(array(''true'', ''false''),');

INSERT INTO configuration VALUES(0, '画像リサイズ', 'IMAGE_MANAGER_CONFIG', 'false', '商品画像の自動リサイズを利用しますか？<br />true 利用する<br />false 利用しない<br /><br />注）この機能を利用するにはサーバーにGDがインストールされている必要があります。', 4, 100, NULL, now(), NULL, 'zen_cfg_select_option(array(''true'', ''false''),');
