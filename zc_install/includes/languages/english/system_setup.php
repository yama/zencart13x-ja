 ...
 */
  ...
  define('PHYSICAL_PATH', 'Physical Path To Zen Cart&trade;');
  define('PHYSICAL_PATH_INSTRUCTION', 'Physical Path to your<br />Zen Cart&trade; directory.<br />Leave no trailing slash.');
  define('VIRTUAL_HTTP_PATH', 'URL to your Zen Cart&trade; store');
  define('VIRTUAL_HTTP_PATH_INSTRUCTION', 'Virtual Path/URL to your<br />Zen Cart&trade; directory.<br />Leave no trailing slash.');
  define('VIRTUAL_HTTPS_PATH', 'HTTPS Server URL');
  define('VIRTUAL_HTTPS_PATH_INSTRUCTION', 'Full Virtual Path to your<br />secure Zen Cart&trade; directory.<br />Leave no trailing slash.');
  define('VIRTUAL_HTTPS_SERVER', 'HTTPS Domain');
  define('VIRTUAL_HTTPS_SERVER_INSTRUCTION', 'Virtual server for your<br />secure Zen Cart&trade; directory.<br />Leave no trailing slash.');
