 ...
 */
  ...
  define('ADMIN_USERNAME_INSTRUCTION', 'Enter the username to be used for your Zen Cart&trade; administrator account.');
  define('ADMIN_PASS', 'Administrator\'s Password');
  define('ADMIN_PASS_INSTRUCTION', 'Enter the password to be used for your Zen Cart&trade; administrator account.');
  define('ADMIN_PASS_CONFIRM', 'Confirm Administrator\'s Password');
  define('ADMIN_PASS_CONFIRM_INSTRUCTION', 'Confirm the password to be used for your Zen Cart&trade; administrator account.');
  define('ADMIN_EMAIL', 'Administrator\'s Email');
  define('ADMIN_EMAIL_INSTRUCTION', 'Enter the email address to be used for your Zen Cart&trade; administrator account.');
