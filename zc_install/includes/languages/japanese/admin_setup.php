 ...
 * @version $Id: admin_setup.php 17 2008-02-14 03:43:21Z bigmouse-sugimoto $
 */
/**
 ...
 */
  ...
  define('ADMIN_USERNAME', '管理者ユーザーID');
  ...
  define('UPGRADE_INSTRUCTION_TEXT','Zen Cartのライブバージョンサーバーに接続してZen Cartが更新されたかをチェックします。Zen Cartが更新されていた場合には、メッセージが表示されますが、自動的に更新されることは<em>ありません</em>。<br />この設定はインストール完了後に 管理画面にログイン->「一般設定」->「ショップ全般の設定」->「Zen Cart新バージョンの自動チェック」で変更することができます。');
