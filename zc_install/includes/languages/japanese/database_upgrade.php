 ...
 * @version $Id: database_upgrade.php 17 2008-02-14 03:43:21Z bigmouse-sugimoto $
 */
/**
 ...
 */
  ...
  define('REASON_TABLE_NOT_FOUND', '存在していないため、テーブル %s に変更もしくは挿入/入替ができません。');
  ...
  define('REASON_CONFIGURATION_GROUP_KEY_ALREADY_EXISTS','既に存在しているため、configuration_group_title "%s" のインサートができません。');
  define('REASON_CONFIGURATION_GROUP_ID_ALREADY_EXISTS','既に存在しているため、configuration_group_id "%s" のインサートができませんん。');
