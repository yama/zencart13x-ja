...
// class methods
    ...
    function install() {
      global $db;
      $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('銀行振込を有効にする', 'MODULE_PAYMENT_MONEYORDER_STATUS', 'False', '銀行振込による支払いを受け付けますか？', '6', '1', 'zen_cfg_select_option(array(\'True\', \'False\'), ', now());");
