 ...
 * @version $Id: paypal_functions.php 2 2010-11-05 09:04:44Z kitsune3 $
**/
 ...
 */
  function ipn_create_order_array($new_order_id, $txn_type) {
    ...
    if (mb_strlen($_POST['first_name']) === strlen($_POST['first_name'])) {
        $sql_data_array['first_name'] = $_POST['first_name'];
        $sql_data_array['last_name'] = $_POST['last_name'];
    } else {
        $sql_data_array['first_name'] = $_POST['last_name'];
        $sql_data_array['last_name'] = $_POST['first_name'];
    }
