 ...
 * @version $Id: order.php 5 2010-11-27 07:29:30Z kitsune3 $
 */
/**
 * order class
 *
...
class order extends base {
  ...
  function query($order_id) {
    ...
    $order_query = "select customers_id, customers_name, customers_company,
                         ...
                         customers_name_kana, delivery_name_kana, billing_name_kana
                        from " . TABLE_ORDERS . "
  ...
  function cart() {
    ...
    $customer_address_query = "select c.customers_firstname, c.customers_lastname,
...
if (!isset($_SESSION['guest_user']) && $_SESSION['guest_user'] != $_SESSION['customer_id']) {
