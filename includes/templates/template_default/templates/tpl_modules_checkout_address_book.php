...
<?php
      while (!$addresses->EOF) {
        if ($addresses->fields['address_book_id'] == $selected_address) {
          echo '      <div id="defaultSelected" class="moduleRowSelected">' . "\n";
        } else {
          echo '      <div class="moduleRow">' . "\n";
        }
?>
        <div class="back"><?php echo zen_draw_radio_field('address', $addresses->fields['address_book_id'], ($addresses->fields['address_book_id'] == $selected_address), 'id="name-' . $addresses->fields['address_book_id'] . '"'); ?></div>
