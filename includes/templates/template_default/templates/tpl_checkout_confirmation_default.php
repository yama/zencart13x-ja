 ...
 * @version $Id: tpl_checkout_confirmation_default.php 29 2008-02-20 09:05:44Z makiya $
 */
?>
...
<?php
  echo zen_draw_form('checkout_confirmation', $form_action_url, 'post', 'id="checkout_confirmation" onsubmit="this.onsubmit=function(){return false}"');
