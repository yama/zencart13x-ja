 ...
 * @version $Id: tpl_contact_us_default.php 2 2010-11-05 09:04:44Z kitsune3 $
 */
?>
...
<?php echo zen_draw_input_field('email', $email, ' size="40" id="email-address"') . '<span class="alert">' . ENTRY_REQUIRED_SYMBOL . '</span>'; ?>
<br class="clearBoth" />
