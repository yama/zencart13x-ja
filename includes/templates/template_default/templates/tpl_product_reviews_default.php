...
<div class="productReviewsDefaultProductMainContent content"><?php echo nl2br(zen_output_string_protected(stripslashes($reviews['reviewsText'])) . ((strlen($reviews['reviewsText']) >= 100) ? '...' : '')); ?></div>
