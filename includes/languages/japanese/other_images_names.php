 ...
 * @version $Id: other_images_names.php 17 2008-02-14 03:43:21Z bigmouse-sugimoto $
 */
...
define('OTHER_BOX_NOTIFY_REMOVE_ALT', 'この商品を削除する');
define('OTHER_BOX_NOTIFY_YES_ALT', 'この商品の最新情報を希望する');
define('OTHER_BOX_WRITE_REVIEW_ALT', 'この商品のレビューを書く');
define('OTHER_CALL_FOR_PRICE_ALT', '価格はお問い合わせ下さい');
define('OTHER_DOWN_FOR_MAINTENANCE_ALT', '当ショップは現在メンテナンス中です。また後ほどお越し下さい。');
define('OTHER_TRANPARENT_ALT', '');
define('OTHER_IMAGE_CUSTOMERS_AUTHORIZATION_ALT', '承認手続き中です...');
define('OTHER_REVIEWS_RATING_STARS_FIVE_ALT', '☆☆☆☆☆');
define('OTHER_REVIEWS_RATING_STARS_FOUR_ALT', '☆☆☆☆');
define('OTHER_REVIEWS_RATING_STARS_THREE_ALT', '☆☆☆');
define('OTHER_REVIEWS_RATING_STARS_TWO_ALT', '☆☆');
define('OTHER_REVIEWS_RATING_STARS_ONE_ALT', '☆');
