...
// +----------------------------------------------------------------------+
// $Id: page_2.php 17 2008-02-14 03:43:21Z bigmouse-sugimoto $
//

define('NAVBAR_TITLE', 'ページ2');
define('HEADING_TITLE', 'ページ2');

define('TEXT_INFORMATION', 'この部分を変更するには、<br /><strong>/includes/languages/japanese/page_2.php</strong>の<strong>define(\'TEXT_INFORMATION\',</strong>の右側の<br />
