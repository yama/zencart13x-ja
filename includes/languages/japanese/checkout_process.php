...
// +----------------------------------------------------------------------+
// $Id: checkout_process.php 17 2008-02-14 03:43:21Z bigmouse-sugimoto $
//
...
define('ERROR_REPETITION_ORDER', '注文ボタンが多重クリックされた可能性があります。マイページにて注文内容を確認して、もし多重注文などが発生していた場合はショップ管理者まで連絡してください。');
?>