...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. Powered by <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a> / <a href="http://www.bigmouse.jp" target="_blank">bigmouse Inc.</a>');
...
// tell a friend box text in sideboxes/tell_a_friend.php
  ...
  define('BOX_TELL_A_FRIEND_TEXT', 'この商品を友達に知らせる');

// wishlist box text in includes/boxes/wishlist.php
  define('BOX_HEADING_CUSTOMER_WISHLIST', 'ウィッシュリスト');
  define('BOX_WISHLIST_EMPTY', 'ウィッシュリストに何も登録されていません');
  define('IMAGE_BUTTON_ADD_WISHLIST', 'ウィッシュリストに加える');
  define('TEXT_WISHLIST_COUNT', '現在ウィッシュリストに商品が %s 点登録されています。');
  define('TEXT_DISPLAY_NUMBER_OF_WISHLIST', '<strong>%d</strong>から <strong>%d</strong>までを表示しています (ウィッシュリストの数:<strong>%d</strong>)');

//New billing address text
  define('SET_AS_PRIMARY' , '標準のお届け先として設定');
...
// javascript messages
  ...
  define('TYPE_BELOW', '下記入力枠に入力してください');

  define('ENTRY_COMPANY', '会社名・部署:');
  define('ENTRY_COMPANY_ERROR', '会社名は最低' . ENTRY_COMPANY_MIN_LENGTH . '文字以上入力してください');
  if (ENTRY_COMPANY_MIN_LENGTH == '' || ENTRY_COMPANY_MIN_LENGTH == '0')  {
...
// Shipping Estimator
  ...
  define('CART_SHIPPING_METHOD_ZIP_REQUIRED','false');
...
// create account - login shared
  ...
  define('CAPTION_UPCOMING_PRODUCTS', 'もうすぐ入荷いたします！');
...
//add bigmouse
  ...
  define('WARNING_SHOPPING_CART_COMBINED', '連絡: 以前のログイン時にカートの中に商品が入っていましたので<br />以前のログイン時の商品とログイン前の商品がカートに入っています。<br />カートの中身を確認してください');
  define('CART_SHIPPING_QUOTE_CRITERIA', '送料は選択された地域で計算されています:');
  define('EMPTY_CART_TEXT_NO_QUOTE', '申し訳有りませんが、カートの中身が空かセッションが切れてしまいました。');
