 ...
 * @version $Id: nochex_apc_test.php 6359 2007-05-22 22:06:30Z wilt $
 */
if (!$_POST) {
  die('Illegal Access');
}
...
?>
<strong>Nochex APC Testing System</strong>
<br />
...
<br /><br />
<form name = "nochex_apc_test_return" method = "post" action = "nochex_apc_test_return.php">
<?php
foreach ($_POST as $key => $value) {
...
<table width="100%">
<tr>
<td>Standard Nochex payment<input type = "radio" name = "paypal_type" value="standard" ></td>
<td>Payment - with following refund<input type = "radio" name = "paypal_type" value="refund" ></td>
<!--<td>eCheck Payment<input type = "radio" name = "paypal_type" value="echeck" ></td>
<td>eCheck plus Cleared<input type = "radio" name = "paypal_type" value="echeckcleared" ></td>-->
</tr>
</table>
<br />
